document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    var offsetPosition = elementTop - navbarHeight;
  ...
  function showFormSuccess(form) {
    ...
    msg.className = 'form-status-message form-success-message';
  ...
  function showFormError(form, message) {
    var msg = document.createElement('div');
    msg.className = 'form-status-message form-failure-message';
    msg.setAttribute('role', 'alert');
  ...
  var animatableElements = document.querySelectorAll(animationSelectors.join(', '));
      ...
      var intersectionObserver = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            var el = entry.target;
            var delay = el.dataset.animateDelay || el.dataset.delay || '0';
            var delayMs = parseFloat(delay) * (delay.toString().indexOf('ms') !== -1 ? 1 : 1000);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "DigitalKey משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'f2d17bb7-8357-460e-935c-005fc16c1aa5',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'f2d17bb7-8357-460e-935c-005fc16c1aa5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f2d17bb7-8357-460e-935c-005fc16c1aa5';
